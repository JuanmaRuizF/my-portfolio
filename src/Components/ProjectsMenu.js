                ...
                <Modal className="Modal" show={show} onHide={() => {setShow(false)}} size="xl">
                  ...
                  {/* <h5>Project overview</h5> */}
                    ...
                    <div>
                      ...
                      <h5>Enlaces</h5>
                      <ul>
                        <li> <a href={s["github_url"]} target="blank"><p className="Link">Repositorio: <ImGithub></ImGithub></p></a></li>
                        {s["deploy_url"].map(i =>{
                          if(i !== "")
                            return ( <li> <a href={s["deploy_url"]} target="blank"><p className="Link">Proyecto hosteado: <GrDeploy></GrDeploy></p></a></li>)
                          return null        
                        })}
