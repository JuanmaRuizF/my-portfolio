...
function AboutMe(props){
    ...
    if(props.language === "English"){
        ...
        skills = <h3 id="Skills">Skills</h3>
    }else{
        myDescription = 
        <Col md={6} sm={12} xs={12} lg={8} xl={8}>
                        <p>Nací y crecí en la isla de Gran Canaria (España), que se encuentra cerca de la costa oeste de África. Aquí completé toda mi educación, desde la educación primaria hasta la universidad. En la universidad estudié el Grado en Ingeniería Informática, con intensificación en Tecnologías de la Información. Durante el tercer año de la universidad, me mudé a Cracovia, Polonia, como parte del programa ERASMUS para estudiar allí durante el año académico 2019-2020.</p>
